...
export default function Nav({ show }: NavProps) {
  ...
  const activeLink =
    inactiveLink + " bg-light-primary text-dark-secondary rounded-l-md";
  const inactiveIcon = "w-6 h-6";
  const activeIcon = inactiveIcon + " text-dark-secondary";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-light-secondary p-4 pr-0 fixed w-full bg-dark-secondary h-full md:static md:w-auto transition-all"
      }
    >
